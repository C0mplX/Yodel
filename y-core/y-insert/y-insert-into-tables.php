...
class y_insert extends connect_database {
	...
	* @param string $table_name, array $column_names, array $column_values
	* 
	*/
	public function insert( $table_name, $column_names, $column_values ) {

		$insert_column_names = mysql_real_escape_string( $this->create_names( $column_names ) );
		$prepare_column_values = mysql_real_escape_string( $this->create_prepared_values( $column_values ) );
